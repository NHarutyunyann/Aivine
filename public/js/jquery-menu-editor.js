...
function MenuEditor(idSelector, options) {
    ...
    var settings = {
        ...
        listOptions: {
            ...
            opener: {
                as: 'html',
                close: '<i class="fas fa-caret-up"></i>',
                open: '<i class="fas fa-caret-down"></i>',
    ...
    $main.on('click', '.btnIn', function (e) {
        ...
        if ($prev.length > 0) {
            ...
            if ($ul.length > 0)
                ...
                var $ul = $('<ul>').addClass('').css('padding-top', '0');
                $prev.append($ul);
                $ul.append($li);
    ...
    function TButtonGroup() {
        ...
        var $btnEdit = TButton({classCss: 'btnEdit', text: settings.labelEdit});
        var $btnRemv = TButton({classCss: 'btnRemove', text: settings.labelRemove});
    ...
    function createMenu(arrayItem, depth) {
        ...
        $.each(arrayItem, function (k, v) {
            ...
            $li.data(itemObject);
            var $div = $('<div>').addClass('listInner').css('overflow', 'auto');
    ...
    this.update = function(){
        ...
        $cEl.find('span.txt').text($cEl.data('name'));
        resetForm();
    };
