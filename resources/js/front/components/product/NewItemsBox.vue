<template>
    ...
    <div class="liquid_product">
        <a href="/product-category/noruytner" class="liquid_product_title_box">
            <img src="/images/icons/clarity_new-line.svg" alt="" class="title_box_img img-new" >
            <span>նորույթ</span>
...
export default {
    ...
    methods: {
        async getProducts() {
            const {data} = await axios.get(`/get-products-by-type/new`)
