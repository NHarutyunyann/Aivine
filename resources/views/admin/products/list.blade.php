            ...
            columns: [
                {
                    ...
                    render: function (data, type, row) {
                        return `<a target="_blank" class="row-title" href="${row.publish_url}">${row.price}</a>
                                    <div>
                                        <ul class="actions-list">
                                            <li><a href="/admin/products/${row.id}/edit">Edit</i></a></li>
                                        ...
                                        <div class="text-center delete-popup delete-confirm-${data} d-none">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <form action="/admin/products/${row.id}" class="delete-form" method="POST">
